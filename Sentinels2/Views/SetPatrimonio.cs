...
namespace Sentinels2.Views
{
    public partial class SetPatrimonio : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            TimeSpan entrada = TimeSpan.Parse(dgvHorarios.CurrentRow.Cells[0].Value.ToString());
            TimeSpan saida = TimeSpan.Parse(dgvHorarios.CurrentRow.Cells[1].Value.ToString());
